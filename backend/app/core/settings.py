...
class Settings(BaseSettings):
    ...
    telegram_config_path: str = Field(default="data/telegram_config.json", alias="TELEGRAM_CONFIG_PATH")
    ...
    @property
    def telegram_config_file(self) -> Path:
        return Path(self.telegram_config_path)
